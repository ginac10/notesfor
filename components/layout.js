  ...
  return (
    <>
      ...
      >
        ...
        <Link href="/send">
          <A variant="styles.navitem">Send</A>
        </Link>
        <ColorButton
          sx={{ ml: [2, 3] }}
          onClick={e => {
      ...
      >
        ...
        >
          <Flex sx={{ justifyContent: 'center' }}>
            <A
              href="https://www.instagram.com/notesforsupport/"
              title="Instagram"
              sx={{ mx: 2 }}
            >
            ...
            <A href="mailto:ginac1128@gmail.com" title="Email" sx={{ mx: 2 }}>
